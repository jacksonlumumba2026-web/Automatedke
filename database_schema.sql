-- =============================================================================
-- ⚠ THIS FILE IS MIGRATION 1 OF 12 — NOT THE COMPLETE CURRENT SCHEMA.
--
-- Kept here as the original foundational migration for historical
-- reference. The authoritative, current schema is the full sequence in
-- supabase/migrations/, applied in order:
--   20260709000000_phase1_foundation.sql                          (this file)
--   20260709000001_phase1_org_creation_function.sql
--   20260709000002_phase1_accept_invitation_function.sql
--   20260709000003_phase1_extend_audit_coverage.sql
--   20260709000004_phase1_notify_on_invitation_accepted.sql
--   20260709000005_phase1_security_advisor_fixes.sql
--   20260709000006_phase1_security_advisor_fixes_round2.sql
--   20260709000007_phase1_performance_advisor_fixes.sql
--   20260709000008_phase1_fix_rls_helper_grants.sql                (critical fix)
--   20260709000009_phase1_fix_ambiguous_slug_reference.sql         (critical fix)
--   20260709000010_phase1_fix_organizations_audit_trigger.sql      (critical fix)
--   20260709000011_phase1_fix_ambiguous_accept_invitation.sql      (critical fix)
--
-- All 12 have been applied to and execution-tested against a live
-- Supabase project. See RLS_Policy_Reference.md's "Security Fix Log" for
-- the full incident history — several real, severe bugs (not just style
-- issues) were found only by actually running this schema, not by
-- reading it.
-- =============================================================================
